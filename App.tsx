  ...
  return (
    <div className="h-screen flex flex-col bg-slate-50 dark:bg-slate-950 transition-colors duration-300 overflow-hidden text-slate-900 dark:text-slate-100">
        ...
        <div className="container mx-auto px-4 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="group relative flex items-center gap-1.5 px-4 py-2 rounded-full bg-slate-100 dark:bg-slate-800 text-xs font-black text-slate-600 dark:text-slate-300 hover:bg-indigo-600 hover:text-white transition-all border border-transparent active:scale-90"
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main key={lang} className="flex-1 min-w-0 bg-slate-50 dark:bg-slate-950 flex flex-col overflow-y-auto overflow-x-hidden relative animate-in fade-in zoom-in-[0.98] duration-500 ease-out">
          <Routes>
