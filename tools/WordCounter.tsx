  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="w-full md:w-72 shrink-0 p-6 bg-slate-50/50 dark:bg-slate-900/40 overflow-y-auto">
          <h3 className="font-extrabold text-slate-800 dark:text-slate-200 mb-6 uppercase tracking-widest text-[10px]">{t('word.analysis')}</h3>
