...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    "legal.sys_info": "시스템 정보",
    "legal.api_key": "현재 API 키 (마스킹)",
    "legal.active_model": "활성 AI 모델",
    "legal.api_status": "API 연결 상태",
    "legal.api_connected": "정상 연결됨",
    "img.convert": "변환하기",
    "img.format": "포맷 선택",
    "img.compress": "압축하기",
    "img.generate": "이미지 생성",
  ...
  en: {
    ...
    "legal.sys_info": "System Information",
    "legal.api_key": "Current API Key (Masked)",
    "legal.active_model": "Active AI Model",
    "legal.api_status": "API Status",
    "legal.api_connected": "Connected",
